...
import WebAuthnAuthenticateButton from "@components/Authentication/EmailWebAuthentication/WebAuthenticationAuthenticateButton";
      ...
      {!user ? (
        ...
        <div style={styles2.container}>
            ...
            <div style={styles2.secretBox}>
              ...
              {superSecretData ? (
                ...
                <>
                  ...
                  <p>
                    Super secret profile information is secured by two factor
                    authentication. To unlock this area complete the WebAuthn
                    flow.
                  </p>
                  {hasRegisteredWebAuthnDevice ? (
                    <>
                    ...
                    <>
                      <p>
                        You have not yet registered a device for Webauthn as a
                        second factor.
                      </p>
                      <button
          ...
          <div style={styles2.details}>
            ...
            <h3>Session</h3>
            <CodeBlock
              codeString={JSON.stringify(session, null, 2).replace(" ", "")}
            />
            <h3>User</h3>
            <CodeBlock
  ...
  try {
    ...
    const hasRegisteredWebAuthnDevice =
      ...
      user.webauthn_registrations.find(
        (i) => i.domain === getDomainFromRequest(context.req, true)
      ) !== undefined;
    ...
    if (
      ...
      session.authentication_factors.find(
        (i) => i.delivery_method === "email"
      ) &&
      session.authentication_factors.find(
        (i) => i.delivery_method === "webauthn_registration"
      )
    ) {
      superSecretData =
